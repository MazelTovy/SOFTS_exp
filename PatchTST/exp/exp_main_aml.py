...
class Exp_Main(Exp_Basic):
    """
    AML: Adaptive Mask Learning for PatchTST
    ...
    def train(self, setting):
        ...
        for epoch in range(self.args.train_epochs):
            ...
            print("Epoch: {0}, Steps: {1} | Train Loss: {2:.7f} Mask Penalty: {3:.7f} Vali Loss: {4:.7f} Test Loss: {5:.7f}".format(
                epoch + 1, train_steps, train_loss, mask_penalty_avg, vali_loss, test_loss))
