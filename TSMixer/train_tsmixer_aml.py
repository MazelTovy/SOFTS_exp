"""
Example training script for TSMixer with AML (Adaptive Mask Learning).
"""
...
def train_model(args):
    ...
    # Save model
    torch.save(model.state_dict(), 'tsmixer_aml_model.pth')
    print("Model saved to 'tsmixer_aml_model.pth'")


def main():
    parser = argparse.ArgumentParser(description='Train TSMixer with AML')
