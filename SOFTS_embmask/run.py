...
parser.add_argument('--beta', type=float, default=1.0, help='coefficient for ZeroMask loss')
parser.add_argument('--gamma', type=float, default=0.1, help='coefficient for Consistency loss')
